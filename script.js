document.addEventListener('DOMContentLoaded', function () {
    ...
    const products = [
        ...
        },
        {
            ...
            description: "Xiaomi 33W Fast Charger –Mi Original & Super Charging",
            details: [
                "Compatibility: Works with Xiaomi, Poco, Redmi",
                "Charging Speed: Ultra-fast charging — up to 50% in just 30 minutes (for supported phones)",
                "Universal Compatibility: Supports USB-PD & QC 3.0 for Xiaomi, Samsung, and more",
                "Safety: Built-in surge protection; original Xiaomi charger",
            ],
            rating: 4.8,
            reviews: 312,
            stock: 17
        ...
        {
            id: 6,
            name: "Mosquito Killing Bat",
            price: 520,
            image: "products/electric_bat.jpg",
            category: "Electric Mosquito Swatter Bat",
            description: "Vision MKB-002 Mosquito Killing Bat - 873525",
            details: [
                "Battery Capacity: 600mAh",
                "Input Voltage: AC 110–220V",
                "Frequency: 50–60Hz",
                "Plug Type: USB 2-Pin Power Cord",
                "Light: One LED Light",
        ...
        },
        {
            ...
            name: "Universe Khata",
            price: 80,
            image: "products/khata.jpg",
            category: "Accessories",
            description: "Universe Khata Sprial 120 Page With Margin",
            details: [
                "Item Code: 78497",
                "Brand: Good Luck Stationary",
                "Manufacturer: Good Luck Stationery",
                "Seller: RFL Store",
                "Design: Attractive",
        ...
        {
            id: 8,
            name: "আত্মশুদ্ধি ও তাসাওউফ",
            price: 300,
            oldPrice: 500,
            image: "products/book.jpg",
            category: "Self-purification & Inspiration",
            description: "আত্মিক উন্নতি ছাড়া মুমিন নিজেকে নফসের ধোঁকা থেকে, শয়তানের কবজা থেকে হেফাজত রাখতে পারে না। মুমিনের আত্মিক উন্নতির এ মাধ্যমই হলো ‘তাসাওউফ’ বা ‘আত্মশুদ্ধি’। ",
            details: [
                "Author: Shaykh al-Islam Mufti Muhammad Taqi Usmani",
                "Publisher: Darut Tibiyan",
                "Pages: 352",
        ...
        },
        {
            ...
            category: "Outdoor",
            description: "Joyroom JR-PBF03 30000mAh 30W Fast Charging Power Bank",
            details: [
                "Model: JR-PBF03",
                "Battery Capacity: 30000mAh (3.7V, 111Wh)",
                "Output Ports: 2× USB-A, 1× Type-C",
                "Features: Large Digital Display, Flashlight",
                "Cable Included: 0.25m USB to Type-C"
            ],
            rating: 4.8,
            reviews: 267,
            stock: 53
